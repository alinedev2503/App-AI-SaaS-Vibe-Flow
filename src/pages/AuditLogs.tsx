  ...
  return (
    <div className="flex flex-col h-[calc(100vh-8rem)]">
      <div className="flex items-center justify-between mb-8">
        <div>
          <h2 className="text-3xl font-black text-white tracking-tight">Audit Logs</h2>
          <p className="text-slate-400 mt-1">Comprehensive system activity and security records.</p>
        </div>
      ...
      <div className="flex gap-6 mb-6">
        <div className="relative flex-1">
          ...
          <input 
            ...
            placeholder="Search logs by Event ID, User, or Action..." 
          />
        </div>
      ...
      <div className="flex-1 bg-[#261933] border border-[#362348] rounded-2xl overflow-hidden flex flex-col">
        ...
        <div className="overflow-y-auto flex-1 custom-scrollbar">
          ...
          <div className="grid grid-cols-12 gap-4 p-4 border-b border-[#362348] hover:bg-white/5 transition-colors items-center group">
            ...
            <div className="col-span-3 text-sm text-slate-300">Updated Agent "Sales Specialist" configuration</div>
          ...
          <div className="grid grid-cols-12 gap-4 p-4 border-b border-[#362348] hover:bg-white/5 transition-colors items-center group">
            ...
            <div className="col-span-2 flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">System (Auto)</span>
            </div>
            <div className="col-span-3 text-sm text-slate-300">Rotated API Keys for Salesforce Integration</div>
            <div className="col-span-2">
              <span className="px-2 py-1 rounded bg-emerald-500/10 text-emerald-400 text-[10px] font-bold uppercase border border-emerald-500/20 flex items-center gap-1 w-fit">
                <CheckCircle className="size-3" /> Success
              </span>
          ...
          <div className="grid grid-cols-12 gap-4 p-4 border-b border-[#362348] hover:bg-white/5 transition-colors items-center group">
            ...
            <div className="col-span-2 flex items-center gap-2">
              ...
              <span className="text-sm font-medium text-white">External IP</span>
            </div>
            <div className="col-span-3 text-sm text-slate-300">Failed login attempt (3x)</div>
            <div className="col-span-2">
