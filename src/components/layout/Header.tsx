    ...
    <header className="h-16 border-b border-border-muted bg-background-light/50 dark:bg-background-dark/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10 ml-64 w-[calc(100%-16rem)]">
      <div className="flex items-center gap-6 flex-1">
        ...
        <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-emerald-500/10 text-emerald-500 border border-emerald-500/20">
          ...
          <span className="text-xs font-bold uppercase tracking-wider">{t('header.mcpConnected')}</span>
        </div>
      </div>
      
      <div className="flex items-center gap-4">
        <button className="p-2 text-slate-500 hover:bg-slate-200 dark:hover:bg-primary/10 rounded-lg relative transition-colors">
        ...
        <button className="p-2 text-slate-500 hover:bg-slate-200 dark:hover:bg-primary/10 rounded-lg transition-colors">
