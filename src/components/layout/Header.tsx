      ...
      <header className="h-16 border-b border-border-muted bg-background-light/50 dark:bg-background-dark/50 backdrop-blur-md flex items-center justify-between px-8 sticky top-0 z-10 ml-64 w-[calc(100%-16rem)]">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="hidden sm:inline-flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-gradient-to-r from-primary to-fuchsia-600 hover:from-primary/90 hover:to-fuchsia-500 text-white text-xs font-black transition-all shadow-md shadow-primary/25 border border-primary/40 animate-pulse hover:animate-none hover:scale-105"
          ...
          <div className="h-8 w-[1px] bg-border-muted mx-1"></div>
